...
-- whole pipeline terminates.
      ...
      => Pipe l a b m r               -- ^ 'Pipe' to run
      -> (e -> Pipe l a b m r)        -- ^ handler function
      -> Pipe l a b m r
...
throw :: (Monad m, E.Exception e) => e -> Pipe l a b m r
throw = throwP . E.toException

-- | Like 'finally', but only performs the final action if there was an
-- exception raised by the 'Pipe'.
onException :: Monad m
            => Pipe l a b m r       -- ^ 'Pipe' to run first
            -> Pipe l a b m s       -- ^ 'Pipe' to run if an exception happens
            -> Pipe l a b m r
...
bracket :: Monad m
        ...
        -> (r -> Pipe l a b m x)  -- ^ 'Pipe' to run in between
        -> Pipe l a b m x
...
bracket_ :: Monad m
         ...
         -> Pipe l a b m x        -- ^ 'Pipe' to run in between
         -> Pipe l a b m x
